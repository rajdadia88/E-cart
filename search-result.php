...
<div class="body-content outer-top-xs">
	<div class='container'>
		<div class='row outer-bottom-sm'>
			<div class='col-md-3 sidebar' style="width: 25%;float: left;position: relative;padding-right: 15px;box-sizing: border-box;min-height: 1px;padding-left: 15px;">
	            <!-- ================================== TOP NAVIGATION ================================== -->
<div class="side-menu animate-dropdown outer-bottom-xs" style="width: 283px;     padding-left: 30px;">       
...
{?>							
		<div class="col-sm-6 col-md-4 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp; width: 33.33333333%; float: left;">
			<div class="products" style="padding-left:80px ;">				
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  style=" width: 200px; height: 250px;" alt=""></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
			
		
		<div class="product-info text-left">
			<h3 class="name" style="font-size: 14px;
    ...
    line-height: 1.5;"><a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['productName']);?></a></h3>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
								...
								<img src="product img\cart-2-48.ico" style="width:15px; height: 15px;     padding: 7px 12px 7px ;"></i>													
							</button>
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist" style="margin-right: 5px;">
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp" style="padding-left: 80px; font-size: 20px;"> <h3>No Product Found</h3>
		</div>
